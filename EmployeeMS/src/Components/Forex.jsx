...
import Forex_Circular from './Forex_Circular';
import Forex_News from './Forex_News';
import Forex_Notice from './Forex_Notice';
import Forex_Post from './Forex_Post';
...
const Forex = () => {
  const [post, setPost] = useState([])
    ...
    useEffect(()=> {
        axios.get('http://localhost:3000/auth/forex')
        .then(result => {
  ...
  return (
    <div>
      ...
      <Link to="/dashboard/forex_post" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Post
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/forex_notice" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Notice
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/forex_news" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        News
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/forex_circular" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Circular
      </Link>
      <div className='mt-3'>
