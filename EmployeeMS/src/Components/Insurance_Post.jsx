...
const Insurance_Post = () => {
    const [post, setPost] = useState([])
    const navigate = useNavigate()
    useEffect(()=> {
        axios.get('http://localhost:3000/auth/post_insurance')
        .then(result => {
        ...
        <table style={{background:'none', color:'white'}}>
          <thead>
            <tr>
              ...
              <th style={{padding:"0 1rem", border:'1px solid white'}}>ACTION</th>
            </tr>
          </thead>
          <tbody>
            {
