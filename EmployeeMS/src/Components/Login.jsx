            ...
            <div className='p-3 rounded w-25 border loginForm'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input type="email" name="email" autoComplete='off' placeholder='Enter Email' onChange={(e) =>
                            setValues({...values, email:e.target.value})} className='form-control rounded-0' />
                    </div>
                    <div className='mb-3'>
                    ...
                    <div className='mb-2'>
                        ...
                        <label htmlFor="password">Agree & Continue</label>
