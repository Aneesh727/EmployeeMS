...
import Gold_Notice from './Gold_Notice';
import Gold_Circular from './Gold_Circular';
import Gold_News from './Gold_News';
import Gold_Post from './Gold_Post';
...
const Gold = () => {
  const [post, setPost] = useState([])
    ...
    useEffect(()=> {
        axios.get('http://localhost:3000/auth/gold')
        .then(result => {
  ...
  return (
    <div>
      ...
      <Link to="/dashboard/gold_post" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Post
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/gold_notice" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Notice
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/gold_news" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        News
      </Link><nbsp></nbsp><nbsp></nbsp><nbsp></nbsp>
      <Link to="/dashboard/gold_circular" className='btn btn-primary btn-sm' style={{ marginRight: '10px' }}>
        Circular
      </Link>
      <div className='mt-3'>
