...
const Insurance_Circular = () => {
    const [post, setPost] = useState([])
    const navigate = useNavigate()
    useEffect(()=> {
        axios.get('http://localhost:3000/auth/circular_insurance')
        .then(result => {
    ...
    <div>
      ...
      <div className='mt-3'>
        <table style={{background:'none', color:'white'}}>
          <thead>
            <tr>
              <th style={{padding:'', border:'1px solid white'}}>NO.</th>
...
export default Insurance_Circular
